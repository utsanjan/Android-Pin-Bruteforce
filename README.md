...
鈴� This takes a bit over 16.6 hours to try all possible 4 digit PINs, but with the optimised PIN list it should take you much less time.

### 馃摫 鉀� 馃摬 You will need
...
## 馃椏 Comparison with other projects and methods to unlock a locked Android phone
...
------------------------------------------------------- | ------------------ | ------------- | ------------------- | ----------- | 
| 猸� Android-PIN-Bruteforce                             | No                 | No            | Nethunter phone     | No          | 
...
There are links to each of these projects in the 馃摎 Related Projects & Futher Reading section.

### 馃槶 Regular phone users
...
### 馃 Users who have already replaced their Android ROM
...
### 馃暤 Security Professionals and Technical Phone Users
...
## 馃摎 Related Projects & Futher Reading
